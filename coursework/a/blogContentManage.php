<?php
	...
	<body> $nav
            <div id='mainContainer'>
                <div id='headingContainer'><span id='pageTitle'>Blog Content</span></div>
                <form id='blogContentForm' name='blogContentForm' action='blogContentManageDB.php' method='post'>
                    Blog ID: <input type='text' name='id' class='pageContentInput' value='$id' readonly>
                    <textarea id='textarea' class='tinymce' name='content' form='blogContentForm'>$content</textarea>
